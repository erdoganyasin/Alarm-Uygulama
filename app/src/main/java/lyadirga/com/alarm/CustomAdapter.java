        ...
        if (modelList!=null) {
            ...
            alarmOnOff.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ((MainActivity) context).setAlarmEnabled(((Long) buttonView.getTag()).longValue(), isChecked);
            ...
            container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MainActivity) context).startAlarmDetailsActivity(((Long) view.getTag()).longValue());
                }
            });
            ...
            container.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ((MainActivity) context).deleteAlarm(((Long) view.getTag()).longValue());
                    return true;
                }
            });
